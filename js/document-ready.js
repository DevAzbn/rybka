...
$(function(){var e=$(".modal-block-container").eq(0),i=e.find(".prev-item-btn").eq(0),c=e.find(".next-item-btn").eq(0),n=e.find(".hide-modal").eq(0),a=e.find(".item");a.eq(0).addClass("active"),i.on("click.fecss",function(e){var i=a.filter(".active"),c=i.prev(".item");i.removeClass("active"),c.size()>0?c.addClass("active"):a.eq(-1).addClass("active")}),c.on("click.fecss",function(e){}),n.on("click.fecss",function(i){e.removeClass("active")})});
